...
const LoginPage = ({ isOpen, onClose, onSwitchToRegister, onSwitchToForgot }) => {
  ...
  const processGoogleOAuthError = (errorMessage) => {
    ...
    if (errorMessage.includes('suspendida temporalmente') ||
      ...
      return '⚠️ Tu cuenta de agencia ha sido suspendida temporalmente.';
    }
  ...
  const getErrorMessage = (error) => {
    ...
    switch (errorCode) {
      ...
      case 'ACCOUNT_SUSPENDED':
        return '⚠️ Tu cuenta está temporalmente suspendida. Contacta al soporte.';
      ...
      case 'TOO_MANY_ATTEMPTS':
        return '⏱️ Demasiados intentos de login. Espera unos minutos antes de intentar nuevamente.';
      ...
      default:
        ...
        switch (status) {
          case 400:
            return '⚠️ Datos de inicio de sesión inválidos. Verifica tu información.';
          case 401:
          ...
          default:
            ...
            // Mensaje por defecto mejorado
            return message || '⚠️ Error inesperado al iniciar sesión. Intenta nuevamente.';
        }
    }
  };
      ...
      {mounted && (
        ...
        >
          ...
          >
            ...
            <div style={{ 
              ...
              <div style={{
                ...
                padding: isMobile ? '120px 25px 30px' : '40px', 
          ...
          <style jsx>{`
            ...
            /* Versión móvil del botón de cerrar - MÁS ABAJO */
