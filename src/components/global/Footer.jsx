      ...
      <div style={responsiveStyles.footerContainer}>
        ...
        <div style={responsiveStyles.footerDisclaimer}>
          <p style={responsiveStyles.disclaimerText}>
            <strong>Aviso Legal:</strong> TeloFundi es una plataforma exclusiva para mayores de 18 años. No somos responsables de los servicios ofrecidos por nuestros anunciantes, todos los usuarios deben cumplir con las leyes locales vigentes. 
          </p>
        </div>
      </div>
    </footer>
